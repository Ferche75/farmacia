...
export function aplicarMapeo(
  ...
  return filas.map((fila) => {
    ...
    return {
      ...
      marca: mapeo.marca ? fila[mapeo.marca] : undefined,
      accionTerapeutica: mapeo.accionTerapeutica ? fila[mapeo.accionTerapeutica] : undefined,
      especialidad: mapeo.especialidad ? fila[mapeo.especialidad] : undefined,
